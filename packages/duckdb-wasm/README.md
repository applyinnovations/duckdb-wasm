...
[![npm](https://img.shields.io/npm/v/@applyinnovations/duckdb-wasm?logo=npm)](https://www.npmjs.com/package/@applyinnovations/duckdb-wasm/v/latest)
[![JSDevlivr](https://data.jsdelivr.com/v1/package/npm/@applyinnovations/duckdb-wasm/badge?style=rounded)](https://www.jsdelivr.com/package/npm/@applyinnovations/duckdb-wasm)
...
```ts
import * as duckdb from '@applyinnovations/duckdb-wasm';
import duckdb_wasm from '@applyinnovations/duckdb-wasm/dist/duckdb-mvp.wasm';
import duckdb_wasm_next from '@applyinnovations/duckdb-wasm/dist/duckdb-eh.wasm';
const MANUAL_BUNDLES: duckdb.DuckDBBundles = {
    mvp: {
        mainModule: duckdb_wasm,
        mainWorker: new URL('@applyinnovations/duckdb-wasm/dist/duckdb-browser-mvp.worker.js', import.meta.url).toString(),
    },
    eh: {
        mainModule: duckdb_wasm_next,
        mainWorker: new URL('@applyinnovations/duckdb-wasm/dist/duckdb-browser-eh.worker.js', import.meta.url).toString(),
    },
};
// Select a bundle based on browser checks
...
```ts
import * as duckdb from '@applyinnovations/duckdb-wasm';
import duckdb_wasm from '@applyinnovations/duckdb-wasm/dist/duckdb-mvp.wasm?url';
import mvp_worker from '@applyinnovations/duckdb-wasm/dist/duckdb-browser-mvp.worker.js?url';
import duckdb_wasm_eh from '@applyinnovations/duckdb-wasm/dist/duckdb-eh.wasm?url';
import eh_worker from '@applyinnovations/duckdb-wasm/dist/duckdb-browser-eh.worker.js?url';
...
await db.instantiate(bundle.mainModule, bundle.pthreadWorker);
```
static served (manually download the files from https://cdn.jsdelivr.net/npm/@applyinnovations/duckdb-wasm/dist/)
```ts
import * as duckdb from '@applyinnovations/duckdb-wasm';
